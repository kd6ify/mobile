...
// TODO StreamHandlingPacket was extending UnknownPacket, which does not exist in the standard smack/asmack distro
...
//						isSmEnabled = true;
// TODO - the following line was using the original JAR, but didn't work in the official aSmack library
...
//			new PacketFilter() { public boolean accept(Packet packet) { return true; }});
	...
	static class StreamHandlingPacket extends DefaultPacketExtension {
		private String name;
