...
public abstract class ImConnection {
     ...
     */
    public abstract void loginAsync(String passwordTemp, boolean retry);
    ...
    /**
     * Gets the instance of FileTransferManager for the connection.
     *
     * @return the instance of FileTransferManager for the connection.
     */
    public abstract EngineFileTransferManager getFileTransferManager();
    ...
    public abstract void publishLocationAsync(Location location);
