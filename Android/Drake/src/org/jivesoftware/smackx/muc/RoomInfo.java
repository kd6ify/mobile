...
public class RoomInfo {
    ...
    RoomInfo(DiscoverInfo info) {
        ...
        if (form != null) {
            ...
            this.description = (descField == null || !(descField.getValues().hasNext())) ? "n/a" : descField.getValues().next();
            FormField subjField = form.getField("muc#roominfo_subject");
            this.subject = ( subjField == null || !(subjField.getValues().hasNext()) ) ? "n/a" : subjField.getValues().next();
