...
import info.guardianproject.otr.app.im.plugin.xmpp.ServerTrustManager;
...
public class XMPPConnection extends Connection {
     ...
     */
    public XMPPConnection(Context context, String serviceName, CallbackHandler callbackHandler) {
     ...
     * @param serviceName the name of the XMPP server to connect to; e.g. <tt>example.com</tt>.
     */
    public XMPPConnection(Context context, String serviceName) {
        // Create the configuration for this new connection
        super(new ConnectionConfiguration(serviceName));
        _context = context;
        config.setCompressionEnabled(false);
     ...
     */
    public XMPPConnection(Context context, ConnectionConfiguration config) {
        super(config);
        _context = context;
    }
     ...
     * @param callbackHandler the CallbackHandler used to prompt for the password to the keystore.
     */
    public XMPPConnection(Context context, ConnectionConfiguration config, CallbackHandler callbackHandler) {
        super(config);
        _context = context;
        config.setCallbackHandler(callbackHandler);
    }
    ...
    void proceedTLSReceived() throws Exception {
        ...
        ServerTrustManager stm = new ServerTrustManager(_context, getServiceName(), config);
        context.init(kms,
                new javax.net.ssl.TrustManager[]{stm},
