...
public class DistanceOverTerrainRulerLayer extends MapComponent.Layer
{
	public static final String ID = "b657c359-0ef9-4bce-8a68-6e6d00d4f072";
	...
	public DistanceOverTerrainRulerLayer(Context context, MapComponent component)
	{
		component.super();
		_id = ID;
	...
	public void addPoint(ScalarFormatter formatter, Point2D.Double point)
	{
		...
		double elevation = getMapComponent().getElevation(point);
