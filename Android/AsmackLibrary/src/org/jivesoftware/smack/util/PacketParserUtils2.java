 ...
 */
public class PacketParserUtils2 {
        ...
        while (!done) {
            ...
            if (eventType == XmlPullParser.START_TAG) {
                ...
                // Otherwise, it must be a packet extension.
                    ...
                    PacketParserUtils2.parsePacketExtension(elementName, namespace, parser));
                }
            }
        ...
        while (!done) {
            ...
            if (eventType == XmlPullParser.START_TAG) {
                ...
                if (elementName.equals("error")) {
                    error = PacketParserUtils2.parseError(parser);
                }
                ...
                // this element name and namespace.
                    ...
                    if (provider != null) {
                        if (provider instanceof IQProvider) {
                            ...
                            iqPacket = (IQ)PacketParserUtils2.parseWithIntrospection(elementName,
            ...
            if (eventType == XmlPullParser.START_TAG) {
                ...
                // Otherwise, it must be a packet extension.
                    ...
                    registration.addExtension(
                        PacketParserUtils2.parsePacketExtension(
                            parser.getName(),
                            parser.getNamespace(),
                            parser));
                }
    ...
    private static ConcurrentHashMap
        <Class<?>, ConcurrentHashMap<String, Method>> INTROSPECTION_CACHE =
        new ConcurrentHashMap<Class<?>, ConcurrentHashMap<String, Method>>();

    private static final String TAG = PacketParserUtils2.class.getSimpleName();
        ...
        while (!done) {
            ...
            if (eventType == XmlPullParser.START_TAG) {
                ...
                ConcurrentHashMap<String, Method> methodCache =
                    INTROSPECTION_CACHE.get(objectClass);
                if (methodCache == null) {
                    INTROSPECTION_CACHE.putIfAbsent(
                        objectClass,
                        new ConcurrentHashMap<String, Method>()
                    );
                    methodCache = INTROSPECTION_CACHE.get(objectClass);
                }
                ...
                if (method == null) {
                    ...
                    for (Method m : objectClass.getMethods()) {
                        ...
                        try {
                            if (decode(m.getParameterTypes()[0], stringValue)
                                == null) {
                                continue;
                            }
                        } catch (Exception e) {
                        ...
                        methodCache.putIfAbsent(name, m);
                    ...
                    if (method == null) {
                        Log.w(TAG,
                            "Could not map "
                            + name + "=" + stringValue +
                            " to a method in " + objectClass.getCanonicalName()
                        );
                    }
                }
                ...
                if (method != null) {
                    ...
                    Object param = decode(paramType, stringValue);
