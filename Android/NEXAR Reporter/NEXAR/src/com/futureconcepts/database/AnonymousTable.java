...
public class AnonymousTable {
	//Database Table
			...
			public static final String[] ANONYMOUS_TABLE_PROJECTION = 
				{ COLUMN_ID,COLUMN_DETAILS,COLUMN_DATE,COLUMN_TYPE,COLUMN_SCHOOL, COLUMN_STUDENTID,COLUMN_DEVICEID};
			...
			private static final String DATABASE_CREATE = "create table "
					...
					+COLUMN_STUDENTID + " varchar(100),"
					+COLUMN_DEVICEID + " varchar(100)"
					+");";
			...
			{
				Log.d("upgrade table","upgrade table");
