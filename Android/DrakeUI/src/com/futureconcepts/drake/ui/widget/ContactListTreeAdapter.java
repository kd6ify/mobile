...
{
	private static final String LOG_TAG = ContactListTreeAdapter.class.getSimpleName();
 ...
 //   private static final int TOKEN_ONGOING_CONVERSATION = -2;
    ...
    void startQuerySubscriptions()
    {
        ...
        mQueryHandler.startQuery(TOKEN_SUBSCRIPTION, null, Imps.Contacts.CONTENT_URI,
    ...
    public int getChildrenCount(int groupPosition) {
       ...
       if (isPosForSubscription(groupPosition)) {
            ...
            {
                Log.w(LOG_TAG, "getChildrenCount out of range");
                return 0;
            }
        ...
        private int getOnlineChildCount(Cursor groupCursor) {
            ...
            if (mOnlineContactsCountMap == null) {
                ...
                Cursor c = cr.query(Imps.Contacts.CONTENT_URI_ONLINE_COUNT,
                        CONTACT_COUNT_PROJECTION, null, null, null);
