...
import com.futureconcepts.drake.ui.utils.DateUtils;
...
public class ContactView extends LinearLayout
{
    ...
    public static final int COLUMN_CONTACT_USERNAME = 1;
    static final int COLUMN_CONTACT_NICKNAME = 2;
    static final int COLUMN_CONTACT_TYPE = 3;
    static final int COLUMN_SUBSCRIPTION_TYPE = 4;
    static final int COLUMN_SUBSCRIPTION_STATUS = 5;
    ...
    public void bind(Cursor cursor, String underLineText, boolean showChatMsg, boolean scrolling) {
        ...
        if (Imps.Contacts.TYPE_GROUP == type) {
            ...
            iconId = lastMsg == null ? R.drawable.status_chat : R.drawable.status_chat_new;
        } else {
            iconId = PresenceUtils.getStatusIconId(presence);
        }
        Drawable presenceIcon = mContext.getResources().getDrawable(iconId);
...
//        } else {
        {
            line1 = TextUtils.isEmpty(nickname) ? username : nickname;
        ...
        if (showChatMsg && hasChat)
        {
            ...
            mTimeStamp.setText(DateUtils.formatMessageTime(getContext(), cursor.getLong(COLUMN_LAST_MESSAGE_DATE)));
        }
        else
        {
        ...
        if (TextUtils.isEmpty(line2)) {
            ...
            // custom status text.
            line2 = getResources().getString(PresenceUtils.getStatusStringRes(presence));
        }
        ...
        if (hasChat && showChatMsg) {
            ...
            mLine2.setTextColor(r.getColor(R.color.chat_contact));
        } else {
