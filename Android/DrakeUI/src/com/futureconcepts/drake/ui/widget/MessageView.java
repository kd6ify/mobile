...
//        }
    ...
    public void bindFileTransferMessage(String filePath, String fileName, String status, long fileSize, long amountWritten)
    {
		double percentComplete = (amountWritten * 100) / fileSize;
    	mTextViewForMessages.setText(String.format("%s %s %3.0f%%", fileName, status, percentComplete));
    	mTextViewForMessages.setTextColor(mResources.getColor(R.color.chat_msg_presence));
    	mDeliveryIcon.setVisibility(INVISIBLE);
    }
