...
public class Markup
{
    ...
    {
    	mContext = context;
        mSmileys = new IntTrie(context.getResources().getStringArray(R.array.default_smiley_texts), context.getResources().getIntArray(R.array.default_smiley_names));
    }
    ...
    public final CharSequence applyEmoticons(CharSequence text) {
        ...
        while (offset < len) {
            ...
            if (candidate != 0) {
                ...
                Drawable smiley = mContext.getResources().getDrawable(candidate);
