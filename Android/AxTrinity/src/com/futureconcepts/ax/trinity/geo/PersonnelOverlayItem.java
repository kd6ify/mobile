...
public class PersonnelOverlayItem extends OverlayItem
{
	public PersonnelOverlayItem(Context context, PersonnelViewCursorByCheckIn cursor)
	{
		super(cursor.getGeoPointFromWKT(), "user", "user");
		boolean markerFound = false;
		byte[] bytes = cursor.getUserTypeIcon();
		if (bytes != null)
		{
