...
class DownloadNotification
{
    ...
    static final String WHERE_RUNNING = 
        "(" + Downloads.Impl.STATUS + " >= '100') AND (" +
        Downloads.Impl.STATUS + " <= '199') AND (" +
        Downloads.Impl.VISIBILITY + " IS NULL OR " +
        Downloads.Impl.VISIBILITY + " == '" + Downloads.Impl.VISIBILITY_VISIBLE + "' OR " +
        Downloads.Impl.VISIBILITY +
            " == '" + Downloads.Impl.VISIBILITY_VISIBLE_NOTIFY_COMPLETED + "')";
    static final String WHERE_COMPLETED =
        Downloads.Impl.STATUS + " >= '200' AND " +
        Downloads.Impl.VISIBILITY +
            " == '" + Downloads.Impl.VISIBILITY_VISIBLE_NOTIFY_COMPLETED + "'";
    ...
    private void updateActiveNotification()
    {
        ...
        for (NotificationItem item : mNotifications.values()) {
            ...
            RemoteViews expandedView = new RemoteViews("com.futureconcepts.mercury", R.layout.status_bar_ongoing_event_progress_bar);
...
//                    title.append("notifition_filename_extras",
 //                           new Object[] { Integer.valueOf(item.mTitleCount - 2) }));
            ...
            intent.setClassName("com.futureconcepts.mercury.provider.download", DownloadReceiver.class.getName());
