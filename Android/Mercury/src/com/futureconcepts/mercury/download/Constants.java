...
public class Constants {
    ...
    public static final String ACTION_RETRY = "com.futureconcepts.intent.action.DOWNLOAD_WAKEUP";

    /** the intent that gets sent when clicking a successful download */
    public static final String ACTION_OPEN = "com.futureconcepts.intent.action.DOWNLOAD_OPEN";

    /** the intent that gets sent when clicking an incomplete/failed download  */
    public static final String ACTION_LIST = "com.futureconcepts.intent.action.DOWNLOAD_LIST";

    /** the intent that gets sent when deleting the notification of a completed download */
    public static final String ACTION_HIDE = "com.futureconcepts.intent.action.DOWNLOAD_HIDE";
    ...
    public static final String DEFAULT_USER_AGENT = "FutureConceptsDownloadManager";
