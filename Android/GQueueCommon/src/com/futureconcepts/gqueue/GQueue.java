...
public class GQueue extends CursorWrapper implements BaseColumns
{
    ...
    public static void clearQueue(Context context, Class<?> theClass)
    {
    	Log.d(TAG, "clearQueue: " + theClass.getSimpleName());
    	ContentResolver resolver = context.getContentResolver();
    	try
    	{
    		resolver.delete(getServiceQueueUri(context, context.getPackageName(), theClass.getName()), null, null);
    	}
    	catch (Exception e) {}
    }
    ...
    public void moveToQueue(Uri destinationQueueUri, String message, String exceptionType)
    {
    	...
    	if (_resolver != null && _contentUri != null && rowId != 0)
    	{
	    	...
	    	values.put(EXCEPTION_TYPE, exceptionType);
