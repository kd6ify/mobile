...
public final class Presence implements Parcelable
{
    ...
    public Presence(int status, String statusText, byte[] avatarData, String avatarType, int clientType, String resource)
    {
        setStatus(status);
    ...
    {
        this(p.mStatus, p.mStatusText, p.mAvatarData, p.mAvatarType, p.mClientType, p.mResource);
    }
