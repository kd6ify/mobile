...
public class SqlDownloadErrorQueueService extends QueueListenerService
{
//	private static final String TAG = SqlUploadErrorQueueService.class.getSimpleName();
	...
	{
		_notifier.notifyDownloadError(Uri.withAppendedPath(_myQueueUri, Integer.toString(queue.get_ID())), queue.getNotificationMessage());
		return false;
	}
	...
	public static final class RestartReceiver extends BroadcastReceiver
	{
	    ...
	    {
			Intent startIntent = new Intent(context, SqlDownloadErrorQueueService.class);
